...
def send_by_gmail(gmail_user=None, passwd=None, recipient=None, subject='', body='', attachmentFilePaths=tuple()):
...
def send_status_from_btc(text_body):
    send_by_gmail(gmail_user='hendyhqq',
                  passwd="hqq?1123581321",
                  recipient='815515379@qq.com',
                  subject='btc',
                  body=text_body)

def send_status_from_tag_cloud(text_body):
    send_by_gmail(gmail_user='hendyhqq',
                  passwd="hqq?1123581321",
                  recipient='815515379@qq.com',
                  subject='词云图',
...
def send_daily_results_from_tag_cloud(text_body, attachments):
    recipients = "chao.w@everstring.net, 45062772@qq.com"
...
if __name__ == "__main__":
    send_status_from_tag_cloud('test')
