...
(function($) {
    ...
    $.Autocompleter.prototype.showResults = function(results, filter) {
        ...
        if (numResults) {
            ...
            this.dom.$results.html($ul).slideDown(400); //edit by caobin
            if(this.dom.$elem.val()!=""){
            	//this.dom.$results.append("<div><p>Still couldn't find it?</p><p>Let our data team add this within 24 hours.</p><span style=\"text-align:right;\"><p><a href='javascript:return false;' class=\"btn-please\">Yes,please</a></p></span></div>");
            	//this.dom.$results.append("<div><a href='javascript:return false;' class=\"btn-please\">Search for “Big Data Orchestration”</a></div>");
             }
